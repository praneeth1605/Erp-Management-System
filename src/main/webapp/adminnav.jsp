...
<body>
 ...
 <!-- Menu Toggle Button -->
    ...
    <nav class="navbar navbar-expand-lg navbar-dark top-navbar fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-right">
                <!-- Notifications -->
                <div class="dropdown">
                    <a class="nav-link notification-badge" href="#" role="button" data-toggle="dropdown">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="adminsettings">
    ...
    <script>
 // Update this script section right before the closing </body> tag
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Add active state to dropdown items
    ...
    <div id="sidebar" class="sidebar">
        ...
        <div class="sidebar-menu">
            <ul class="nav flex-column">
                ...
                <!-- Students Management -->
                <li class="nav-item">
                    <a class="nav-link" href="#studentsMenu" data-toggle="collapse" aria-expanded="false">
                        <i class="fas fa-user-graduate"></i>
                        Students
                ...
                <!-- Faculty Management -->
                <li class="nav-item">
                    <a class="nav-link" href="#facultyMenu" data-toggle="collapse" aria-expanded="false">
                ...
                <!-- Courses Management -->
                <li class="nav-item">
                    <a class="nav-link" href="#coursesMenu" data-toggle="collapse" aria-expanded="false">
                        <i class="fas fa-book"></i>
                        Courses
                        <i class="fas fa-chevron-down ms-auto"></i>
                    </a>
                    <div class="collapse" id="coursesMenu">
                        <ul class="nav flex-column pl-3">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="viewallcourses">
                                    <i class="fas fa-list"></i>
                                    Manage Courses
                                </a>
                            </li>
                ...
                <!-- Course Mapping -->
                <li class="nav-item">
                    <a class="nav-link" href="coursemapping">
                ...
                <!-- View Mapped Courses -->
                <li class="nav-item">
                    <a class="nav-link" href="viewcoursemappedfaculty">
    ...
    document.getElementById('menuToggle').addEventListener('click', function() {
        ...
        if (sidebar.classList.contains('sidebar-hidden')) {
            menuToggle.style.left = '20px'; // Move to the left corner when sidebar is hidden
        } else {
            menuToggle.style.left = '290px'; // Restore default position when sidebar is visible
        }
