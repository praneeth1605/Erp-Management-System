...
<body>
    ...
    <div class="container">
        <h1 class="text-center mb-4" style="color: var(--primary-color);">Post Internals</h1>
        ...
        <form action="/faculty/internalspost" method="post">
                ...
                <table class="table-attendance">
                    <thead>
                        <tr>
                            <th>Student ID</th>
                            <th>Student Name</th>
                            <th class="text-center">Enter Marks(Out of 60)</th>
                        </tr>
                    </thead>
                    <tbody>
