...
<head>
    ...
    <title>EduVerse Student Portal</title>
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600;700&family=Roboto:wght@300;400;500;700&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <style>
        /* [Previous CSS remains the same, with minor modifications] */
        :root {
            --primary-color: #3498DB;  /* Changed to a student-friendly blue */
            --secondary-color: #2980B9;
            --accent-color: #2ECC71;   /* Changed to a fresh green */
            --text-light: #FFFFFF;
                ...
                <div class="dropdown">
                    <div class="admin-profile" data-toggle="dropdown">
                        ...
                        <div class="admin-info">
                            <span class="admin-name"><%=s.getName() %></span>
                            <span class="admin-role">Student</span>
                        </div>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        // Explicit dropdown initialization
        $('.dropdown-toggle').dropdown();
        
        // Add click event handler as a backup
