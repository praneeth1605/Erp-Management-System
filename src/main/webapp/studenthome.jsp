                ...
                <div class="dashboard-card card border-left-warning h-100 py-2">
                    <div class="card-body">
                        <div class="text-center">
                            ...
                            <div class="stat-value">
                                <%= request.getAttribute("degreeProgress") != null ? request.getAttribute("degreeProgress") : "72%" %>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="row">
        <div class="col-xl-8 col-lg-7">
            <div class="academic-overview">
                <h4 class="mb-4">Current Semester Courses</h4>
                <div class="activity-item">
                    <strong>Java</strong>
                    <div class="progress progress-bar-custom mt-2">
                        <div class="progress-bar bg-primary" role="progressbar" style="width: 85%;" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                    <small class="text-muted">Current Grade: A (85%)</small>
                </div>
                <div class="activity-item">
                    ...
                    <small class="text-muted">Current Grade: A+ (92%)</small>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-4 col-lg-5">
            <div class="academic-overview">
                ...
                <div class="list-group">
                    ...
                    <a href="transcripts" class="list-group-item list-group-item-action">
                        <i class="fas fa-file-alt mr-2"></i>View Transcripts
                    </a>
                    <a href="schedule" class="list-group-item list-group-item-action">
                        <i class="fas fa-calendar-check mr-2"></i>View Class Schedule
                    </a>
                </div>
            </div>
        </div>
